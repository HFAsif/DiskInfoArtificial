...
namespace DiskInfoArtificial.Library
{
    ...
    public class ImportantElements_Enums
    {
        ...
        [Flags]
        internal enum HOST_READS_WRITES_UNIT
        {
        ...
        [Flags]
        internal enum TStoragePropertyId
        {
        ...
        [Flags]
        internal enum TStorageQueryType
        {
        ...
        [Flags]
        internal enum TStroageProtocolType
        {
        ...
        [Flags]
        internal enum MutantAccess : uint
        {
